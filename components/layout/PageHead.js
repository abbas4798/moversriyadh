    ...
    return (
        <>
            <Head>
                ...
                <meta property="og:title" content={headTitle || "Moving Services in Riyadh, Saudi Arabia"} />
                <meta property="og:description" content={description || "Top moving services in Riyadh, Saudi Arabia. We offer reliable, fast, and professional moving solutions for individuals and businesses."} />
                {/* <meta property="og:image" content="/path-to-your-image.jpg" />  Replace with the actual image URL */}
                <meta property="og:url" content={typeof window !== "undefined" ? window.location.href : ""} />
                
                {/* Twitter Card Meta Tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content={headTitle || "Moving Services in Riyadh, Saudi Arabia"} />
                <meta name="twitter:description" content={description || "Top moving services in Riyadh, Saudi Arabia. We offer reliable, fast, and professional moving solutions for individuals and businesses."} />
